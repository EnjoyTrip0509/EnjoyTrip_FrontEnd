      ...
      <div v-if="this.dialog" class="content">
        <div class="review-header">
          <div class="review-header-title">
            리뷰 작성
            <font-awesome-icon class="review-icon" :icon="['fas', 'message']" />
          </div>
        </div>

        <div class="review-info">
          <img
            :src="attraction.firstImage || require(`@/assets/planet-earth.png`)"
            alt="관광지 이미지"
          />
        ...
        <div class="button-box">
          <v-btn color="green darken-1" text @click="registerReview"
            >등록</v-btn
          >
          <v-btn color="red darken-1 " text @click="closeWriteReviewModal"
            >닫기</v-btn
          >
        </div>
      </div>
